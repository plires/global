      ...
      <tr style="background-color: #fefefe;">
        <td style="padding: 40px; padding-top: 0px;">
          ...
          <h2 class="fallback-font" style="margin: 0 0 20px 0; padding-top: 40px; font-family: 'Montserrat', sans-serif; font-size: 22px; line-height: 32px; color: #3f3e3e; text-align: center; font-weight: 700; text-transform: uppercase;">
            <strong>NUEVO CONTACTO DESDE JGLOBAL</strong>
          </h2>

          <br>

          <h3 class="fallback-font" style="margin: 0 0 10px 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #000000; text-align: left; font-weight: 700;">
            <strong>Los datos que proporcionaron son los siguientes:</strong>
          </h3>
